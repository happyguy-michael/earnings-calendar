...
export const earnings: Earning[] = [
  // ===== JANUARY 2026 =====
  // Week of Jan 13
  { ticker: 'JPM', company: 'JPMorgan Chase', date: '2026-01-14', time: 'pre', eps: 4.81, estimate: 4.53, result: 'beat', revenue: 44.2, revenueEstimate: 42.8, priceMove: 3.2 },
  { ticker: 'WFC', company: 'Wells Fargo', date: '2026-01-14', time: 'pre', eps: 1.58, estimate: 1.43, result: 'beat', revenue: 20.8, revenueEstimate: 20.5, priceMove: 5.7 },
  { ticker: 'GS', company: 'Goldman Sachs', date: '2026-01-15', time: 'pre', eps: 11.95, estimate: 8.65, result: 'beat', revenue: 13.9, revenueEstimate: 12.4, priceMove: 8.4 },
  { ticker: 'BAC', company: 'Bank of America', date: '2026-01-16', time: 'pre', eps: 0.82, estimate: 0.77, result: 'beat', revenue: 25.3, revenueEstimate: 25.0, priceMove: 2.1 },
  { ticker: 'MS', company: 'Morgan Stanley', date: '2026-01-16', time: 'pre', eps: 2.22, estimate: 1.87, result: 'beat', revenue: 16.2, revenueEstimate: 15.1, priceMove: 6.2 },
  { ticker: 'TSM', company: 'TSMC', date: '2026-01-16', time: 'pre', eps: 2.24, estimate: 2.18, result: 'beat', revenue: 26.4, revenueEstimate: 25.8, priceMove: 4.5 },
  { ticker: 'UNH', company: 'UnitedHealth', date: '2026-01-16', time: 'pre', eps: 6.81, estimate: 6.72, result: 'beat', revenue: 100.8, revenueEstimate: 99.5, priceMove: 1.3 },
  
  // Week of Jan 20
  { ticker: 'NFLX', company: 'Netflix', date: '2026-01-21', time: 'post', eps: 4.27, estimate: 4.20, result: 'beat', revenue: 10.2, revenueEstimate: 10.1, priceMove: 9.8 },
  { ticker: 'JNJ', company: 'Johnson & Johnson', date: '2026-01-22', time: 'pre', eps: 2.04, estimate: 2.02, result: 'beat', revenue: 22.5, revenueEstimate: 22.3, priceMove: 0.8 },
  { ticker: 'ASML', company: 'ASML', date: '2026-01-22', time: 'pre', eps: 6.89, estimate: 6.78, result: 'beat', revenue: 9.3, revenueEstimate: 9.1, priceMove: 3.4 },
  { ticker: 'GE', company: 'GE Aerospace', date: '2026-01-23', time: 'pre', eps: 1.32, estimate: 1.18, result: 'beat', revenue: 9.9, revenueEstimate: 9.5, priceMove: 7.1 },
  { ticker: 'TSLA', company: 'Tesla', date: '2026-01-23', time: 'post', eps: 0.66, estimate: 0.76, result: 'miss', revenue: 25.7, revenueEstimate: 25.5, priceMove: -8.6 },
  { ticker: 'IBM', company: 'IBM', date: '2026-01-23', time: 'post', eps: 3.92, estimate: 3.78, result: 'beat', revenue: 17.5, revenueEstimate: 17.2, priceMove: 2.9 },
  
  // Week of Jan 27
  { ticker: 'AAPL', company: 'Apple', date: '2026-01-28', time: 'post', eps: 2.35, estimate: 2.36, result: 'miss', revenue: 124.3, revenueEstimate: 124.1, priceMove: -1.2 },
  { ticker: 'MSFT', company: 'Microsoft', date: '2026-01-28', time: 'post', eps: 3.23, estimate: 3.11, result: 'beat', revenue: 69.6, revenueEstimate: 68.8, priceMove: 4.8 },
  { ticker: 'META', company: 'Meta Platforms', date: '2026-01-29', time: 'post', eps: 8.02, estimate: 6.77, result: 'beat', revenue: 48.4, revenueEstimate: 46.9, priceMove: 15.3 },
  { ticker: 'AMZN', company: 'Amazon', date: '2026-01-30', time: 'post', eps: 1.86, estimate: 1.82, result: 'beat', revenue: 187.8, revenueEstimate: 185.5, priceMove: 3.5 },
  { ticker: 'GOOGL', company: 'Alphabet', date: '2026-01-30', time: 'post', eps: 2.15, estimate: 2.08, result: 'beat', revenue: 96.5, revenueEstimate: 95.2, priceMove: 2.7 },
  
  // ===== FEBRUARY 2026 =====
  // Week of Feb 3
  { ticker: 'AMD', company: 'AMD', date: '2026-02-04', time: 'post', eps: 1.09, estimate: 1.07, result: 'beat', revenue: 7.5, revenueEstimate: 7.3, priceMove: 1.8 },
  { ticker: 'QCOM', company: 'Qualcomm', date: '2026-02-05', time: 'post', eps: 3.41, estimate: 3.12, result: 'beat', revenue: 11.4, revenueEstimate: 10.9, priceMove: 6.5 },
  { ticker: 'ARM', company: 'Arm Holdings', date: '2026-02-05', time: 'post', eps: 0.39, estimate: 0.35, result: 'beat', revenue: 0.98, revenueEstimate: 0.94, priceMove: 12.1 },
  { ticker: 'UBER', company: 'Uber', date: '2026-02-05', time: 'pre', eps: 0.42, estimate: 0.39, result: 'beat', revenue: 11.2, revenueEstimate: 10.8, priceMove: 4.2 },
  { ticker: 'DIS', company: 'Disney', date: '2026-02-06', time: 'pre', eps: 1.76, estimate: 1.45, result: 'beat', revenue: 24.7, revenueEstimate: 24.1, priceMove: 11.5 },
  { ticker: 'LLY', company: 'Eli Lilly', date: '2026-02-06', time: 'pre', eps: 5.32, estimate: 5.14, result: 'beat', revenue: 13.5, revenueEstimate: 12.9, priceMove: 5.8 },
  
  // Week of Feb 10
  { ticker: 'KO', company: 'Coca-Cola', date: '2026-02-11', time: 'pre', eps: 0.55, estimate: 0.52, result: 'beat', revenue: 11.5, revenueEstimate: 11.3, priceMove: 1.9 },
  { ticker: 'SHOP', company: 'Shopify', date: '2026-02-11', time: 'pre', eps: 0.44, estimate: 0.39, result: 'beat', revenue: 2.8, revenueEstimate: 2.65, priceMove: 8.3 },
  { ticker: 'CSCO', company: 'Cisco', date: '2026-02-12', time: 'post', eps: 0.94, estimate: 0.91, result: 'beat', revenue: 14.2, revenueEstimate: 14.0, priceMove: 2.2 },
  { ticker: 'COIN', company: 'Coinbase', date: '2026-02-13', time: 'post', eps: 4.68, estimate: 1.89, result: 'beat', revenue: 2.27, revenueEstimate: 1.78, priceMove: 18.7 },
  { ticker: 'AMAT', company: 'Applied Materials', date: '2026-02-13', time: 'post', eps: 2.38, estimate: 2.29, result: 'beat', revenue: 7.2, revenueEstimate: 7.0, priceMove: 3.6 },
  { ticker: 'ROKU', company: 'Roku', date: '2026-02-13', time: 'post', eps: 1.17, estimate: 0.98, result: 'beat', revenue: 1.06, revenueEstimate: 0.98, priceMove: 14.2 },
  
  // Week of Feb 17
  { ticker: 'WMT', company: 'Walmart', date: '2026-02-18', time: 'pre', eps: 0.66, estimate: 0.64, result: 'beat', revenue: 180.5, revenueEstimate: 178.2, priceMove: 3.1 },
  { ticker: 'PANW', company: 'Palo Alto Networks', date: '2026-02-18', time: 'post', eps: 0.81, estimate: 0.77, result: 'beat', revenue: 2.35, revenueEstimate: 2.28, priceMove: 4.7 },
  { ticker: 'BKNG', company: 'Booking Holdings', date: '2026-02-19', time: 'post', eps: 41.55, estimate: 38.28, result: 'beat', revenue: 5.9, revenueEstimate: 5.7, priceMove: 6.9 },
  { ticker: 'MCD', company: "McDonald's", date: '2026-02-19', time: 'pre', eps: 2.83, estimate: 2.86, result: 'miss', revenue: 6.4, revenueEstimate: 6.5, priceMove: -2.4 },
  
  // Week of Feb 24
  { ticker: 'DPZ', company: "Domino's Pizza", date: '2026-02-24', time: 'pre', eps: 5.39, estimate: 5.45, result: 'miss', revenue: 1.48, revenueEstimate: 1.52, priceMove: -4.1 },
  { ticker: 'HD', company: 'Home Depot', date: '2026-02-24', time: 'pre', eps: 2.52, estimate: 2.48, result: 'beat', revenue: 39.7, revenueEstimate: 39.2, priceMove: 2.3 },
  { ticker: 'HIMS', company: 'Hims & Hers Health', date: '2026-02-24', time: 'post', eps: 0.11, estimate: 0.05, result: 'beat', revenue: 0.48, revenueEstimate: 0.44, priceMove: 22.4 },
  { ticker: 'LOW', company: "Lowe's", date: '2026-02-25', time: 'pre', eps: 1.93, estimate: 1.88, result: 'beat', revenue: 18.6, revenueEstimate: 18.3, priceMove: 1.7 },
  { ticker: 'TJX', company: 'TJX Companies', date: '2026-02-25', time: 'pre', eps: 1.24, estimate: 1.18, result: 'beat', revenue: 16.4, revenueEstimate: 16.1, priceMove: 3.9 },
  { ticker: 'WDAY', company: 'Workday', date: '2026-02-25', time: 'post', eps: 2.32, estimate: 2.25, result: 'beat', revenue: 2.15, revenueEstimate: 2.10, priceMove: 5.4 },
